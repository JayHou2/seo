...
const translations = {
  en: {
    ...
    launchEyebrow: "Shareable Starting Points",
    launchTitle: "Start distribution with the pages most likely to answer a real question.",
    launchText: "These links include UTM tags so GA4 can show which channels bring useful visitors.",
    shareToolTitle: "Student budget calculator",
    shareToolText: "Best first link for Reddit, X, parent groups, and general student communities.",
    shareNyTitle: "New York student cost guide",
    shareNyText: "Use when posting in school, city, or housing-related discussions.",
    shareFirstMonthTitle: "First-month abroad budget",
    shareFirstMonthText: "Useful for offer holders, parents, and pre-departure groups.",
  ...
  zh: {
    ...
    openArticles: "打开文章库",
    launchEyebrow: "可分发入口",
    launchTitle: "先分发最能回答真实问题的页面。",
    launchText: "这些链接带有 UTM 参数，GA4 可以看到哪些渠道带来有效访问。",
    shareToolTitle: "学生生活成本计算器",
    shareToolText: "适合发到 Reddit、X、家长群和通用学生社区。",
    shareNyTitle: "纽约留学生生活费指南",
    shareNyText: "适合发到学校、城市、租房相关讨论里。",
    shareFirstMonthTitle: "出国第一个月预算清单",
    shareFirstMonthText: "适合 offer holder、家长和行前准备群。",
